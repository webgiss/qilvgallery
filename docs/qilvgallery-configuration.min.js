...
return jQuery.inArray(elem.jquery?elem[0]:elem,this)},add:function(selector,context){var set=typeof selector==="string"?jQuery(selector,context||this.context):jQuery.makeArray(selector),all=jQuery.merge(this.get(),set);return this.pushStack(isDisconnected(set[0])||isDisconnected(all[0])?all:jQuery.unique(all))},andSelf:function(){return this.add(this.prevObject)}});function isDisconnected(node){return!node||!node.parentNode||node.parentNode.nodeType===11}jQuery.each({parent:function(elem){var parent=elem.parentNode;return parent&&parent.nodeType!==11?parent:null},parents:function(elem){return jQuery.dir(elem,"parentNode")},parentsUntil:function(elem,i,until){return jQuery.dir(elem,"parentNode",until)},next:function(elem){return jQuery.nth(elem,2,"nextSibling")},prev:function(elem){return jQuery.nth(elem,2,"previousSibling")},nextAll:function(elem){return jQuery.dir(elem,"nextSibling")},prevAll:function(elem){return jQuery.dir(elem,"previousSibling")},nextUntil:function(elem,i,until){return jQuery.dir(elem,"nextSibling",until)},prevUntil:function(elem,i,until){return jQuery.dir(elem,"previousSibling",until)},siblings:function(elem){return jQuery.sibling(elem.parentNode.firstChild,elem)},children:function(elem){return jQuery.sibling(elem.firstChild)},contents:function(elem){return jQuery.nodeName(elem,"iframe")?elem.contentDocument||elem.contentWindow.document:jQuery.makeArray(elem.childNodes)}},function(name,fn){jQuery.fn[name]=function(until,selector){var ret=jQuery.map(this,fn,until);if(!runtil.test(name)){selector=until}if(selector&&typeof selector==="string"){ret=jQuery.filter(selector,ret)}ret=this.length>1?jQuery.unique(ret):ret;if((this.length>1||rmultiselector.test(selector))&&rparentsprev.test(name)){ret=ret.reverse()}return this.pushStack(ret,name,slice.call(arguments).join(","))}});jQuery.extend({filter:function(expr,elems,not){if(not){expr=":not("+expr+")"}return elems.length===1?jQuery.find.matchesSelector(elems[0],expr)?[elems[0]]:[]:jQuery.find.matches(expr,elems)},dir:function(elem,dir,until){var matched=[],cur=elem[dir];while(cur&&cur.nodeType!==9&&(until===undefined||cur.nodeType!==1||!jQuery(cur).is(until))){if(cur.nodeType===1){matched.push(cur)}cur=cur[dir]}return matched},nth:function(cur,result,dir,elem){result=result||1;var num=0;for(;cur;cur=cur[dir]){if(cur.nodeType===1&&++num===result){break}}return cur},sibling:function(n,elem){var r=[];for(;n;n=n.nextSibling){if(n.nodeType===1&&n!==elem){r.push(n)}}return r}});function winnow(elements,qualifier,keep){if(jQuery.isFunction(qualifier)){return jQuery.grep(elements,function(elem,i){var retVal=!!qualifier.call(elem,i,elem);return retVal===keep})}else if(qualifier.nodeType){return jQuery.grep(elements,function(elem,i){return elem===qualifier===keep})}else if(typeof qualifier==="string"){var filtered=jQuery.grep(elements,function(elem){return elem.nodeType===1});if(isSimple.test(qualifier)){return jQuery.filter(qualifier,filtered,!keep)}else{qualifier=jQuery.filter(qualifier,filtered)}}return jQuery.grep(elements,function(elem,i){return jQuery.inArray(elem,qualifier)>=0===keep})}var rinlinejQuery=/ jQuery\d+="(?:\d+|null)"/g,rleadingWhitespace=/^\s+/,rxhtmlTag=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,rtagName=/<([\w:]+)/,rtbody=/<tbody/i,rhtml=/<|&#?\w+;/,rnocache=/<(?:script|object|embed|option|style)/i,rchecked=/checked\s*(?:[^=]|=\s*.checked.)/i,raction=/\=([^="'>\s]+\/)>/g,wrapMap={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]};wrapMap.optgroup=wrapMap.option;wrapMap.tbody=wrapMap.tfoot=wrapMap.colgroup=wrapMap.caption=wrapMap.thead;wrapMap.th=wrapMap.td;if(!jQuery.support.htmlSerialize){wrapMap._default=[1,"div<div>","</div>"]}jQuery.fn.extend({text:function(text){if(jQuery.isFunction(text)){return this.each(function(i){var self=jQuery(this);self.text(text.call(this,i,self.text()))})}if(typeof text!=="object"&&text!==undefined){return this.empty().append((this[0]&&this[0].ownerDocument||document).createTextNode(text))}return jQuery.text(this)},wrapAll:function(html){if(jQuery.isFunction(html)){return this.each(function(i){jQuery(this).wrapAll(html.call(this,i))})}if(this[0]){var wrap=jQuery(html,this[0].ownerDocument).eq(0).clone(true);if(this[0].parentNode){wrap.insertBefore(this[0])}wrap.map(function(){var elem=this;while(elem.firstChild&&elem.firstChild.nodeType===1){elem=elem.firstChild}return elem}).append(this)}return this},wrapInner:function(html){if(jQuery.isFunction(html)){return this.each(function(i){jQuery(this).wrapInner(html.call(this,i))})}return this.each(function(){var self=jQuery(this),contents=self.contents();if(contents.length){contents.wrapAll(html)}else{self.append(html)}})},wrap:function(html){return this.each(function(){jQuery(this).wrapAll(html)})},unwrap:function(){return this.parent().each(function(){if(!jQuery.nodeName(this,"body")){jQuery(this).replaceWith(this.childNodes)}}).end()},append:function(){return this.domManip(arguments,true,function(elem){if(this.nodeType===1){this.appendChild(elem)}})},prepend:function(){return this.domManip(arguments,true,function(elem){if(this.nodeType===1){this.insertBefore(elem,this.firstChild)}})},before:function(){if(this[0]&&this[0].parentNode){return this.domManip(arguments,false,function(elem){this.parentNode.insertBefore(elem,this)})}else if(arguments.length){var set=jQuery(arguments[0]);set.push.apply(set,this.toArray());return this.pushStack(set,"before",arguments)}},after:function(){if(this[0]&&this[0].parentNode){return this.domManip(arguments,false,function(elem){this.parentNode.insertBefore(elem,this.nextSibling)})}else if(arguments.length){var set=this.pushStack(this,"after",arguments);set.push.apply(set,jQuery(arguments[0]).toArray());return set}},remove:function(selector,keepData){for(var i=0,elem;(elem=this[i])!=null;i++){if(!selector||jQuery.filter(selector,[elem]).length){if(!keepData&&elem.nodeType===1){jQuery.cleanData(elem.getElementsByTagName("*"));jQuery.cleanData([elem])}if(elem.parentNode){elem.parentNode.removeChild(elem)}}}return this},empty:function(){for(var i=0,elem;(elem=this[i])!=null;i++){if(elem.nodeType===1){jQuery.cleanData(elem.getElementsByTagName("*"))}while(elem.firstChild){elem.removeChild(elem.firstChild)}}return this},clone:function(events){var ret=this.map(function(){if(!jQuery.support.noCloneEvent&&!jQuery.isXMLDoc(this)){var html=this.outerHTML,ownerDocument=this.ownerDocument;if(!html){var div=ownerDocument.createElement("div");div.appendChild(this.cloneNode(true));html=div.innerHTML}return jQuery.clean([html.replace(rinlinejQuery,"").replace(raction,'="$1">').replace(rleadingWhitespace,"")],ownerDocument)[0]}else{return this.cloneNode(true)}});if(events===true){cloneCopyEvent(this,ret);cloneCopyEvent(this.find("*"),ret.find("*"))}return ret},html:function(value){if(value===undefined){return this[0]&&this[0].nodeType===1?this[0].innerHTML.replace(rinlinejQuery,""):null}else if(typeof value==="string"&&!rnocache.test(value)&&(jQuery.support.leadingWhitespace||!rleadingWhitespace.test(value))&&!wrapMap[(rtagName.exec(value)||["",""])[1].toLowerCase()]){value=value.replace(rxhtmlTag,"<$1></$2>");try{for(var i=0,l=this.length;i<l;i++){if(this[i].nodeType===1){jQuery.cleanData(this[i].getElementsByTagName("*"));this[i].innerHTML=value}}}catch(e){this.empty().append(value)}}else if(jQuery.isFunction(value)){this.each(function(i){var self=jQuery(this);self.html(value.call(this,i,self.html()))})}else{this.empty().append(value)}return this},replaceWith:function(value){if(this[0]&&this[0].parentNode){if(jQuery.isFunction(value)){return this.each(function(i){var self=jQuery(this),old=self.html();self.replaceWith(value.call(this,i,old))})}if(typeof value!=="string"){value=jQuery(value).detach()}return this.each(function(){var next=this.nextSibling,parent=this.parentNode;jQuery(this).remove();if(next){jQuery(next).before(value)}else{jQuery(parent).append(value)}})}else{return this.pushStack(jQuery(jQuery.isFunction(value)?value():value),"replaceWith",value)}},detach:function(selector){return this.remove(selector,true)},domManip:function(args,table,callback){var results,first,fragment,parent,value=args[0],scripts=[];if(!jQuery.support.checkClone&&arguments.length===3&&typeof value==="string"&&rchecked.test(value)){return this.each(function(){jQuery(this).domManip(args,table,callback,true)})}if(jQuery.isFunction(value)){return this.each(function(i){var self=jQuery(this);args[0]=value.call(this,i,table?self.html():undefined);self.domManip(args,table,callback)})}if(this[0]){parent=value&&value.parentNode;if(jQuery.support.parentNode&&parent&&parent.nodeType===11&&parent.childNodes.length===this.length){results={fragment:parent}}else{results=jQuery.buildFragment(args,this,scripts)}fragment=results.fragment;if(fragment.childNodes.length===1){first=fragment=fragment.firstChild}else{first=fragment.firstChild}if(first){table=table&&jQuery.nodeName(first,"tr");for(var i=0,l=this.length;i<l;i++){callback.call(table?root(this[i],first):this[i],i>0||results.cacheable||this.length>1?fragment.cloneNode(true):fragment)}}if(scripts.length){jQuery.each(scripts,evalScript)}}return this}});function root(elem,cur){return jQuery.nodeName(elem,"table")?elem.getElementsByTagName("tbody")[0]||elem.appendChild(elem.ownerDocument.createElement("tbody")):elem}function cloneCopyEvent(orig,ret){var i=0;ret.each(function(){if(this.nodeName!==(orig[i]&&orig[i].nodeName)){return}var oldData=jQuery.data(orig[i++]),curData=jQuery.data(this,oldData),events=oldData&&oldData.events;if(events){delete curData.handle;curData.events={};for(var type in events){for(var handler in events[type]){jQuery.event.add(this,type,events[type][handler],events[type][handler].data)}}}})}jQuery.buildFragment=function(args,nodes,scripts){var fragment,cacheable,cacheresults,doc=nodes&&nodes[0]?nodes[0].ownerDocument||nodes[0]:document;if(args.length===1&&typeof args[0]==="string"&&args[0].length<512&&doc===document&&!rnocache.test(args[0])&&(jQuery.support.checkClone||!rchecked.test(args[0]))){cacheable=true;cacheresults=jQuery.fragments[args[0]];if(cacheresults){if(cacheresults!==1){fragment=cacheresults}}}if(!fragment){fragment=doc.createDocumentFragment();jQuery.clean(args,doc,fragment,scripts)}if(cacheable){jQuery.fragments[args[0]]=cacheresults?fragment:1}return{fragment:fragment,cacheable:cacheable}};jQuery.fragments={};jQuery.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(name,original){jQuery.fn[name]=function(selector){var ret=[],insert=jQuery(selector),parent=this.length===1&&this[0].parentNode;if(parent&&parent.nodeType===11&&parent.childNodes.length===1&&insert.length===1){insert[original](this[0]);return this}else{for(var i=0,l=insert.length;i<l;i++){var elems=(i>0?this.clone(true):this).get();jQuery(insert[i])[original](elems);ret=ret.concat(elems)}return this.pushStack(ret,name,insert.selector)}}});jQuery.extend({clean:function(elems,context,fragment,scripts){context=context||document;if(typeof context.createElement==="undefined"){context=context.ownerDocument||context[0]&&context[0].ownerDocument||document}var ret=[];for(var i=0,elem;(elem=elems[i])!=null;i++){if(typeof elem==="number"){elem+=""}if(!elem){continue}if(typeof elem==="string"&&!rhtml.test(elem)){elem=context.createTextNode(elem)}else if(typeof elem==="string"){elem=elem.replace(rxhtmlTag,"<$1></$2>");var tag=(rtagName.exec(elem)||["",""])[1].toLowerCase(),wrap=wrapMap[tag]||wrapMap._default,depth=wrap[0],div=context.createElement("div");div.innerHTML=wrap[1]+elem+wrap[2];while(depth--){div=div.lastChild}if(!jQuery.support.tbody){var hasBody=rtbody.test(elem),tbody=tag==="table"&&!hasBody?div.firstChild&&div.firstChild.childNodes:wrap[1]==="<table>"&&!hasBody?div.childNodes:[];for(var j=tbody.length-1;j>=0;--j){if(jQuery.nodeName(tbody[j],"tbody")&&!tbody[j].childNodes.length){tbody[j].parentNode.removeChild(tbody[j])}}}if(!jQuery.support.leadingWhitespace&&rleadingWhitespace.test(elem)){div.insertBefore(context.createTextNode(rleadingWhitespace.exec(elem)[0]),div.firstChild)}elem=div.childNodes}if(elem.nodeType){ret.push(elem)}else{ret=jQuery.merge(ret,elem)}}if(fragment){for(i=0;ret[i];i++){if(scripts&&jQuery.nodeName(ret[i],"script")&&(!ret[i].type||ret[i].type.toLowerCase()==="text/javascript")){scripts.push(ret[i].parentNode?ret[i].parentNode.removeChild(ret[i]):ret[i])}else{if(ret[i].nodeType===1){ret.splice.apply(ret,[i+1,0].concat(jQuery.makeArray(ret[i].getElementsByTagName("script"))))}fragment.appendChild(ret[i])}}}return ret},cleanData:function(elems){var data,id,cache=jQuery.cache,special=jQuery.event.special,deleteExpando=jQuery.support.deleteExpando;for(var i=0,elem;(elem=elems[i])!=null;i++){if(elem.nodeName&&jQuery.noData[elem.nodeName.toLowerCase()]){continue}id=elem[jQuery.expando];if(id){data=cache[id];if(data&&data.events){for(var type in data.events){if(special[type]){jQuery.event.remove(elem,type)}else{jQuery.removeEvent(elem,type,data.handle)}}}if(deleteExpando){delete elem[jQuery.expando]}else if(elem.removeAttribute){elem.removeAttribute(jQuery.expando)}delete cache[id]}}}});function evalScript(i,elem){if(elem.src){jQuery.ajax({url:elem.src,async:false,dataType:"script"})}else{jQuery.globalEval(elem.text||elem.textContent||elem.innerHTML||"")}if(elem.parentNode){elem.parentNode.removeChild(elem)}}var ralpha=/alpha\([^)]*\)/i,ropacity=/opacity=([^)]*)/,rdashAlpha=/-([a-z])/gi,rupper=/([A-Z])/g,rnumpx=/^-?\d+(?:px)?$/i,rnum=/^-?\d/,cssShow={position:"absolute",visibility:"hidden",display:"block"},cssWidth=["Left","Right"],cssHeight=["Top","Bottom"],curCSS,getComputedStyle,currentStyle,fcamelCase=function(all,letter){return letter.toUpperCase()};jQuery.fn.css=function(name,value){if(arguments.length===2&&value===undefined){return this}return jQuery.access(this,name,value,true,function(elem,name,value){return value!==undefined?jQuery.style(elem,name,value):jQuery.css(elem,name)})};jQuery.extend({cssHooks:{opacity:{get:function(elem,computed){if(computed){var ret=curCSS(elem,"opacity","opacity");return ret===""?"1":ret}else{return elem.style.opacity}}}},cssNumber:{zIndex:true,fontWeight:true,opacity:true,zoom:true,lineHeight:true},cssProps:{float:jQuery.support.cssFloat?"cssFloat":"styleFloat"},style:function(elem,name,value,extra){if(!elem||elem.nodeType===3||elem.nodeType===8||!elem.style){return}var ret,origName=jQuery.camelCase(name),style=elem.style,hooks=jQuery.cssHooks[origName];name=jQuery.cssProps[origName]||origName;if(value!==undefined){if(typeof value==="number"&&isNaN(value)||value==null){return}if(typeof value==="number"&&!jQuery.cssNumber[origName]){value+="px"}if(!hooks||!("set"in hooks)||(value=hooks.set(elem,value))!==undefined){try{style[name]=value}catch(e){}}}else{if(hooks&&"get"in hooks&&(ret=hooks.get(elem,false,extra))!==undefined){return ret}return style[name]}},css:function(elem,name,extra){var ret,origName=jQuery.camelCase(name),hooks=jQuery.cssHooks[origName];name=jQuery.cssProps[origName]||origName;if(hooks&&"get"in hooks&&(ret=hooks.get(elem,true,extra))!==undefined){return ret}else if(curCSS){return curCSS(elem,name,origName)}},swap:function(elem,options,callback){var old={};for(var name in options){old[name]=elem.style[name];elem.style[name]=options[name]}callback.call(elem);for(name in options){elem.style[name]=old[name]}},camelCase:function(string){return string.replace(rdashAlpha,fcamelCase)}});jQuery.curCSS=jQuery.css;jQuery.each(["height","width"],function(i,name){jQuery.cssHooks[name]={get:function(elem,computed,extra){var val;if(computed){if(elem.offsetWidth!==0){val=getWH(elem,name,extra)}else{jQuery.swap(elem,cssShow,function(){val=getWH(elem,name,extra)})}if(val<=0){val=curCSS(elem,name,name);if(val==="0px"&&currentStyle){val=currentStyle(elem,name,name)}if(val!=null){return val===""||val==="auto"?"0px":val}}if(val<0||val==null){val=elem.style[name];return val===""||val==="auto"?"0px":val}return typeof val==="string"?val:val+"px"}},set:function(elem,value){if(rnumpx.test(value)){value=parseFloat(value);if(value>=0){return value+"px"}}else{return value}}}});if(!jQuery.support.opacity){jQuery.cssHooks.opacity={get:function(elem,computed){return ropacity.test((computed&&elem.currentStyle?elem.currentStyle.filter:elem.style.filter)||"")?parseFloat(RegExp.$1)/100+"":computed?"1":""},set:function(elem,value){var style=elem.style;style.zoom=1;var opacity=jQuery.isNaN(value)?"":"alpha(opacity="+value*100+")",filter=style.filter||"";style.filter=ralpha.test(filter)?filter.replace(ralpha,opacity):style.filter+" "+opacity}}}if(document.defaultView&&document.defaultView.getComputedStyle){getComputedStyle=function(elem,newName,name){var ret,defaultView,computedStyle;name=name.replace(rupper,"-$1").toLowerCase();if(!(defaultView=elem.ownerDocument.defaultView)){return undefined}if(computedStyle=defaultView.getComputedStyle(elem,null)){ret=computedStyle.getPropertyValue(name);if(ret===""&&!jQuery.contains(elem.ownerDocument.documentElement,elem)){ret=jQuery.style(elem,name)}}return ret}}if(document.documentElement.currentStyle){currentStyle=function(elem,name){var left,rsLeft,ret=elem.currentStyle&&elem.currentStyle[name],style=elem.style;if(!rnumpx.test(ret)&&rnum.test(ret)){left=style.left;rsLeft=elem.runtimeStyle.left;elem.runtimeStyle.left=elem.currentStyle.left;style.left=name==="fontSize"?"1em":ret||0;ret=style.pixelLeft+"px";style.left=left;elem.runtimeStyle.left=rsLeft}return ret===""?"auto":ret}}curCSS=getComputedStyle||currentStyle;function getWH(elem,name,extra){var which=name==="width"?cssWidth:cssHeight,val=name==="width"?elem.offsetWidth:elem.offsetHeight;if(extra==="border"){return val}jQuery.each(which,function(){if(!extra){val-=parseFloat(jQuery.css(elem,"padding"+this))||0}if(extra==="margin"){val+=parseFloat(jQuery.css(elem,"margin"+this))||0}else{val-=parseFloat(jQuery.css(elem,"border"+this+"Width"))||0}});return val}if(jQuery.expr&&jQuery.expr.filters){jQuery.expr.filters.hidden=function(elem){var width=elem.offsetWidth,height=elem.offsetHeight;return width===0&&height===0||!jQuery.support.reliableHiddenOffsets&&(elem.style.display||jQuery.css(elem,"display"))==="none"};jQuery.expr.filters.visible=function(elem){return!jQuery.expr.filters.hidden(elem)}}var jsc=jQuery.now(),rscript=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,rselectTextarea=/^(?:select|textarea)/i,rinput=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,rnoContent=/^(?:GET|HEAD)$/,rbracket=/\[\]$/,jsre=/\=\?(&|$)/,rquery=/\?/,rts=/([?&])_=[^&]*/,rurl=/^(\w+:)?\/\/([^\/?#]+)/,r20=/%20/g,rhash=/#.*$/,_load=jQuery.fn.load;jQuery.fn.extend({load:function(url,params,callback){if(typeof url!=="string"&&_load){return _load.apply(this,arguments)}else if(!this.length){return this}var off=url.indexOf(" ");if(off>=0){var selector=url.slice(off,url.length);url=url.slice(0,off)}var type="GET";if(params){if(jQuery.isFunction(params)){callback=params;params=null}else if(typeof params==="object"){params=jQuery.param(params,jQuery.ajaxSettings.traditional);type="POST"}}var self=this;jQuery.ajax({url:url,type:type,dataType:"html",data:params,complete:function(res,status){if(status==="success"||status==="notmodified"){self.html(selector?jQuery("<div>").append(res.responseText.replace(rscript,"")).find(selector):res.responseText)}if(callback){self.each(callback,[res.responseText,status,res])}}});return this},serialize:function(){return jQuery.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?jQuery.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||rselectTextarea.test(this.nodeName)||rinput.test(this.type))}).map(function(i,elem){var val=jQuery(this).val();return val==null?null:jQuery.isArray(val)?jQuery.map(val,function(val,i){return{name:elem.name,value:val}}):{name:elem.name,value:val}}).get()}});jQuery.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(i,o){jQuery.fn[o]=function(f){return this.bind(o,f)}});jQuery.extend({get:function(url,data,callback,type){if(jQuery.isFunction(data)){type=type||callback;callback=data;data=null}return jQuery.ajax({type:"GET",url:url,data:data,success:callback,dataType:type})},getScript:function(url,callback){return jQuery.get(url,null,callback,"script")},getJSON:function(url,data,callback){return jQuery.get(url,data,callback,"json")},post:function(url,data,callback,type){if(jQuery.isFunction(data)){type=type||callback;callback=data;data={}}return jQuery.ajax({type:"POST",url:url,data:data,success:callback,dataType:type})},ajaxSetup:function(settings){jQuery.extend(jQuery.ajaxSettings,settings)},ajaxSettings:{url:location.href,global:true,type:"GET",contentType:"application/x-www-form-urlencoded",processData:true,async:true,xhr:function(){return new window.XMLHttpRequest},accepts:{xml:"application/xml, text/xml",html:"text/html",script:"text/javascript, application/javascript",json:"application/json, text/javascript",text:"text/plain",_default:"*/*"}},ajax:function(origSettings){var s=jQuery.extend(true,{},jQuery.ajaxSettings,origSettings),jsonp,status,data,type=s.type.toUpperCase(),noContent=rnoContent.test(type);s.url=s.url.replace(rhash,"");s.context=origSettings&&origSettings.context!=null?origSettings.context:s;if(s.data&&s.processData&&typeof s.data!=="string"){s.data=jQuery.param(s.data,s.traditional)}if(s.dataType==="jsonp"){if(type==="GET"){if(!jsre.test(s.url)){s.url+=(rquery.test(s.url)?"&":"?")+(s.jsonp||"callback")+"=?"}}else if(!s.data||!jsre.test(s.data)){s.data=(s.data?s.data+"&":"")+(s.jsonp||"callback")+"=?"}s.dataType="json"}if(s.dataType==="json"&&(s.data&&jsre.test(s.data)||jsre.test(s.url))){jsonp=s.jsonpCallback||"jsonp"+jsc++;if(s.data){s.data=(s.data+"").replace(jsre,"="+jsonp+"$1")}s.url=s.url.replace(jsre,"="+jsonp+"$1");s.dataType="script";var customJsonp=window[jsonp];window[jsonp]=function(tmp){if(jQuery.isFunction(customJsonp)){customJsonp(tmp)}else{window[jsonp]=undefined;try{delete window[jsonp]}catch(jsonpError){}}data=tmp;jQuery.handleSuccess(s,xhr,status,data);jQuery.handleComplete(s,xhr,status,data);if(head){head.removeChild(script)}}}if(s.dataType==="script"&&s.cache===null){s.cache=false}if(s.cache===false&&noContent){var ts=jQuery.now();var ret=s.url.replace(rts,"$1_="+ts);s.url=ret+(ret===s.url?(rquery.test(s.url)?"&":"?")+"_="+ts:"")}if(s.data&&noContent){s.url+=(rquery.test(s.url)?"&":"?")+s.data}if(s.global&&jQuery.active++===0){jQuery.event.trigger("ajaxStart")}var parts=rurl.exec(s.url),remote=parts&&(parts[1]&&parts[1].toLowerCase()!==location.protocol||parts[2].toLowerCase()!==location.host);if(s.dataType==="script"&&type==="GET"&&remote){var head=document.getElementsByTagName("head")[0]||document.documentElement;var script=document.createElement("script");if(s.scriptCharset){script.charset=s.scriptCharset}script.src=s.url;if(!jsonp){var done=false;script.onload=script.onreadystatechange=function(){if(!done&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){done=true;jQuery.handleSuccess(s,xhr,status,data);jQuery.handleComplete(s,xhr,status,data);script.onload=script.onreadystatechange=null;if(head&&script.parentNode){head.removeChild(script)}}}}head.insertBefore(script,head.firstChild);return undefined}var requestDone=false;var xhr=s.xhr();if(!xhr){return}if(s.username){xhr.open(type,s.url,s.async,s.username,s.password)}else{xhr.open(type,s.url,s.async)}try{if(s.data!=null&&!noContent||origSettings&&origSettings.contentType){xhr.setRequestHeader("Content-Type",s.contentType)}if(s.ifModified){if(jQuery.lastModified[s.url]){xhr.setRequestHeader("If-Modified-Since",jQuery.lastModified[s.url])}if(jQuery.etag[s.url]){xhr.setRequestHeader("If-None-Match",jQuery.etag[s.url])}}if(!remote){xhr.setRequestHeader("X-Requested-With","XMLHttpRequest")}xhr.setRequestHeader("Accept",s.dataType&&s.accepts[s.dataType]?s.accepts[s.dataType]+", */*; q=0.01":s.accepts._default)}catch(headerError){}if(s.beforeSend&&s.beforeSend.call(s.context,xhr,s)===false){if(s.global&&jQuery.active--===1){jQuery.event.trigger("ajaxStop")}xhr.abort();return false}if(s.global){jQuery.triggerGlobal(s,"ajaxSend",[xhr,s])}var onreadystatechange=xhr.onreadystatechange=function(isTimeout){if(!xhr||xhr.readyState===0||isTimeout==="abort"){if(!requestDone){jQuery.handleComplete(s,xhr,status,data)}requestDone=true;if(xhr){xhr.onreadystatechange=jQuery.noop}}else if(!requestDone&&xhr&&(xhr.readyState===4||isTimeout==="timeout")){requestDone=true;xhr.onreadystatechange=jQuery.noop;status=isTimeout==="timeout"?"timeout":!jQuery.httpSuccess(xhr)?"error":s.ifModified&&jQuery.httpNotModified(xhr,s.url)?"notmodified":"success";var errMsg;if(status==="success"){try{data=jQuery.httpData(xhr,s.dataType,s)}catch(parserError){status="parsererror";errMsg=parserError}}if(status==="success"||status==="notmodified"){if(!jsonp){jQuery.handleSuccess(s,xhr,status,data)}}else{jQuery.handleError(s,xhr,status,errMsg)}if(!jsonp){jQuery.handleComplete(s,xhr,status,data)}if(isTimeout==="timeout"){xhr.abort()}if(s.async){xhr=null}}};try{var oldAbort=xhr.abort;xhr.abort=function(){if(xhr){Function.prototype.call.call(oldAbort,xhr)}onreadystatechange("abort")}}catch(abortError){}if(s.async&&s.timeout>0){setTimeout(function(){if(xhr&&!requestDone){onreadystatechange("timeout")}},s.timeout)}try{xhr.send(noContent||s.data==null?null:s.data)}catch(sendError){jQuery.handleError(s,xhr,null,sendError);jQuery.handleComplete(s,xhr,status,data)}if(!s.async){onreadystatechange()}return xhr},param:function(a,traditional){var s=[],add=function(key,value){value=jQuery.isFunction(value)?value():value;s[s.length]=encodeURIComponent(key)+"="+encodeURIComponent(value)};if(traditional===undefined){traditional=jQuery.ajaxSettings.traditional}if(jQuery.isArray(a)||a.jquery){jQuery.each(a,function(){add(this.name,this.value)})}else{for(var prefix in a){buildParams(prefix,a[prefix],traditional,add)}}return s.join("&").replace(r20,"+")}});function buildParams(prefix,obj,traditional,add){if(jQuery.isArray(obj)&&obj.length){jQuery.each(obj,function(i,v){if(traditional||rbracket.test(prefix)){add(prefix,v)}else{buildParams(prefix+"["+(typeof v==="object"||jQuery.isArray(v)?i:"")+"]",v,traditional,add)}})}else if(!traditional&&obj!=null&&typeof obj==="object"){if(jQuery.isEmptyObject(obj)){add(prefix,"")}else{jQuery.each(obj,function(k,v){buildParams(prefix+"["+k+"]",v,traditional,add)})}}else{add(prefix,obj)}}jQuery.extend({active:0,lastModified:{},etag:{},handleError:function(s,xhr,status,e){if(s.error){s.error.call(s.context,xhr,status,e)}if(s.global){jQuery.triggerGlobal(s,"ajaxError",[xhr,s,e])}},handleSuccess:function(s,xhr,status,data){if(s.success){s.success.call(s.context,data,status,xhr)}if(s.global){jQuery.triggerGlobal(s,"ajaxSuccess",[xhr,s])}},handleComplete:function(s,xhr,status){if(s.complete){s.complete.call(s.context,xhr,status)}if(s.global){jQuery.triggerGlobal(s,"ajaxComplete",[xhr,s])}if(s.global&&jQuery.active--===1){jQuery.event.trigger("ajaxStop")}},triggerGlobal:function(s,type,args){(s.context&&s.context.url==null?jQuery(s.context):jQuery.event).trigger(type,args)},httpSuccess:function(xhr){try{return!xhr.status&&location.protocol==="file:"||xhr.status>=200&&xhr.status<300||xhr.status===304||xhr.status===1223}catch(e){}return false},httpNotModified:function(xhr,url){var lastModified=xhr.getResponseHeader("Last-Modified"),etag=xhr.getResponseHeader("Etag");if(lastModified){jQuery.lastModified[url]=lastModified}if(etag){jQuery.etag[url]=etag}return xhr.status===304},httpData:function(xhr,type,s){var ct=xhr.getResponseHeader("content-type")||"",xml=type==="xml"||!type&&ct.indexOf("xml")>=0,data=xml?xhr.responseXML:xhr.responseText;if(xml&&data.documentElement.nodeName==="parsererror"){jQuery.error("parsererror")}if(s&&s.dataFilter){data=s.dataFilter(data,type)}if(typeof data==="string"){if(type==="json"||!type&&ct.indexOf("json")>=0){data=jQuery.parseJSON(data)}else if(type==="script"||!type&&ct.indexOf("javascript")>=0){jQuery.globalEval(data)}}return data}});if(window.ActiveXObject){jQuery.ajaxSettings.xhr=function(){if(window.location.protocol!=="file:"){try{return new window.XMLHttpRequest}catch(xhrError){}}try{return new window.ActiveXObject("Microsoft.XMLHTTP")}catch(activeError){}}}jQuery.support.ajax=!!jQuery.ajaxSettings.xhr();var elemdisplay={},rfxtypes=/^(?:toggle|show|hide)$/,rfxnum=/^([+\-]=)?([\d+.\-]+)(.*)$/,timerId,fxAttrs=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]];jQuery.fn.extend({show:function(speed,easing,callback){var elem,display;if(speed||speed===0){return this.animate(genFx("show",3),speed,easing,callback)}else{for(var i=0,j=this.length;i<j;i++){elem=this[i];display=elem.style.display;if(!jQuery.data(elem,"olddisplay")&&display==="none"){display=elem.style.display=""}if(display===""&&jQuery.css(elem,"display")==="none"){jQuery.data(elem,"olddisplay",defaultDisplay(elem.nodeName))}}for(i=0;i<j;i++){elem=this[i];display=elem.style.display;if(display===""||display==="none"){elem.style.display=jQuery.data(elem,"olddisplay")||""}}return this}},hide:function(speed,easing,callback){if(speed||speed===0){return this.animate(genFx("hide",3),speed,easing,callback)}else{for(var i=0,j=this.length;i<j;i++){var display=jQuery.css(this[i],"display");if(display!=="none"){jQuery.data(this[i],"olddisplay",display)}}for(i=0;i<j;i++){this[i].style.display="none"}return this}},_toggle:jQuery.fn.toggle,toggle:function(fn,fn2,callback){var bool=typeof fn==="boolean";if(jQuery.isFunction(fn)&&jQuery.isFunction(fn2)){this._toggle.apply(this,arguments)}else if(fn==null||bool){this.each(function(){var state=bool?fn:jQuery(this).is(":hidden");jQuery(this)[state?"show":"hide"]()})}else{this.animate(genFx("toggle",3),fn,fn2,callback)}return this},fadeTo:function(speed,to,easing,callback){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:to},speed,easing,callback)},animate:function(prop,speed,easing,callback){var optall=jQuery.speed(speed,easing,callback);if(jQuery.isEmptyObject(prop)){return this.each(optall.complete)}return this[optall.queue===false?"each":"queue"](function(){var opt=jQuery.extend({},optall),p,isElement=this.nodeType===1,hidden=isElement&&jQuery(this).is(":hidden"),self=this;for(p in prop){var name=jQuery.camelCase(p);if(p!==name){prop[name]=prop[p];delete prop[p];p=name}if(prop[p]==="hide"&&hidden||prop[p]==="show"&&!hidden){return opt.complete.call(this)}if(isElement&&(p==="height"||p==="width")){opt.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(jQuery.css(this,"display")==="inline"&&jQuery.css(this,"float")==="none"){if(!jQuery.support.inlineBlockNeedsLayout){this.style.display="inline-block"}else{var display=defaultDisplay(this.nodeName);if(display==="inline"){this.style.display="inline-block"}else{this.style.display="inline";this.style.zoom=1}}}}if(jQuery.isArray(prop[p])){(opt.specialEasing=opt.specialEasing||{})[p]=prop[p][1];prop[p]=prop[p][0]}}if(opt.overflow!=null){this.style.overflow="hidden"}opt.curAnim=jQuery.extend({},prop);jQuery.each(prop,function(name,val){var e=new jQuery.fx(self,opt,name);if(rfxtypes.test(val)){e[val==="toggle"?hidden?"show":"hide":val](prop)}else{var parts=rfxnum.exec(val),start=e.cur()||0;if(parts){var end=parseFloat(parts[2]),unit=parts[3]||"px";if(unit!=="px"){jQuery.style(self,name,(end||1)+unit);start=(end||1)/e.cur()*start;jQuery.style(self,name,start+unit)}if(parts[1]){end=(parts[1]==="-="?-1:1)*end+start}e.custom(start,end,unit)}else{
e.custom(start,val,"")}}});return true})},stop:function(clearQueue,gotoEnd){var timers=jQuery.timers;if(clearQueue){this.queue([])}this.each(function(){for(var i=timers.length-1;i>=0;i--){if(timers[i].elem===this){if(gotoEnd){timers[i](true)}timers.splice(i,1)}}});if(!gotoEnd){this.dequeue()}return this}});function genFx(type,num){var obj={};jQuery.each(fxAttrs.concat.apply([],fxAttrs.slice(0,num)),function(){obj[this]=type});return obj}jQuery.each({slideDown:genFx("show",1),slideUp:genFx("hide",1),slideToggle:genFx("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(name,props){jQuery.fn[name]=function(speed,easing,callback){return this.animate(props,speed,easing,callback)}});jQuery.extend({speed:function(speed,easing,fn){var opt=speed&&typeof speed==="object"?jQuery.extend({},speed):{complete:fn||!fn&&easing||jQuery.isFunction(speed)&&speed,duration:speed,easing:fn&&easing||easing&&!jQuery.isFunction(easing)&&easing};opt.duration=jQuery.fx.off?0:typeof opt.duration==="number"?opt.duration:opt.duration in jQuery.fx.speeds?jQuery.fx.speeds[opt.duration]:jQuery.fx.speeds._default;opt.old=opt.complete;opt.complete=function(){if(opt.queue!==false){jQuery(this).dequeue()}if(jQuery.isFunction(opt.old)){opt.old.call(this)}};return opt},easing:{linear:function(p,n,firstNum,diff){return firstNum+diff*p},swing:function(p,n,firstNum,diff){return(-Math.cos(p*Math.PI)/2+.5)*diff+firstNum}},timers:[],fx:function(elem,options,prop){this.options=options;this.elem=elem;this.prop=prop;if(!options.orig){options.orig={}}}});jQuery.fx.prototype={update:function(){if(this.options.step){this.options.step.call(this.elem,this.now,this)}(jQuery.fx.step[this.prop]||jQuery.fx.step._default)(this)},cur:function(){if(this.elem[this.prop]!=null&&(!this.elem.style||this.elem.style[this.prop]==null)){return this.elem[this.prop]}var r=parseFloat(jQuery.css(this.elem,this.prop));return r&&r>-1e4?r:0},custom:function(from,to,unit){var self=this,fx=jQuery.fx;this.startTime=jQuery.now();this.start=from;this.end=to;this.unit=unit||this.unit||"px";this.now=this.start;this.pos=this.state=0;function t(gotoEnd){return self.step(gotoEnd)}t.elem=this.elem;if(t()&&jQuery.timers.push(t)&&!timerId){timerId=setInterval(fx.tick,fx.interval)}},show:function(){this.options.orig[this.prop]=jQuery.style(this.elem,this.prop);this.options.show=true;this.custom(this.prop==="width"||this.prop==="height"?1:0,this.cur());jQuery(this.elem).show()},hide:function(){this.options.orig[this.prop]=jQuery.style(this.elem,this.prop);this.options.hide=true;this.custom(this.cur(),0)},step:function(gotoEnd){var t=jQuery.now(),done=true;if(gotoEnd||t>=this.options.duration+this.startTime){this.now=this.end;this.pos=this.state=1;this.update();this.options.curAnim[this.prop]=true;for(var i in this.options.curAnim){if(this.options.curAnim[i]!==true){done=false}}if(done){if(this.options.overflow!=null&&!jQuery.support.shrinkWrapBlocks){var elem=this.elem,options=this.options;jQuery.each(["","X","Y"],function(index,value){elem.style["overflow"+value]=options.overflow[index]})}if(this.options.hide){jQuery(this.elem).hide()}if(this.options.hide||this.options.show){for(var p in this.options.curAnim){jQuery.style(this.elem,p,this.options.orig[p])}}this.options.complete.call(this.elem)}return false}else{var n=t-this.startTime;this.state=n/this.options.duration;var specialEasing=this.options.specialEasing&&this.options.specialEasing[this.prop];var defaultEasing=this.options.easing||(jQuery.easing.swing?"swing":"linear");this.pos=jQuery.easing[specialEasing||defaultEasing](this.state,n,0,1,this.options.duration);this.now=this.start+(this.end-this.start)*this.pos;this.update()}return true}};jQuery.extend(jQuery.fx,{tick:function(){var timers=jQuery.timers;for(var i=0;i<timers.length;i++){if(!timers[i]()){timers.splice(i--,1)}}if(!timers.length){jQuery.fx.stop()}},interval:13,stop:function(){clearInterval(timerId);timerId=null},speeds:{slow:600,fast:200,_default:400},step:{opacity:function(fx){jQuery.style(fx.elem,"opacity",fx.now)},_default:function(fx){if(fx.elem.style&&fx.elem.style[fx.prop]!=null){fx.elem.style[fx.prop]=(fx.prop==="width"||fx.prop==="height"?Math.max(0,fx.now):fx.now)+fx.unit}else{fx.elem[fx.prop]=fx.now}}}});if(jQuery.expr&&jQuery.expr.filters){jQuery.expr.filters.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length}}function defaultDisplay(nodeName){if(!elemdisplay[nodeName]){var elem=jQuery("<"+nodeName+">").appendTo("body"),display=elem.css("display");elem.remove();if(display==="none"||display===""){display="block"}elemdisplay[nodeName]=display}return elemdisplay[nodeName]}var rtable=/^t(?:able|d|h)$/i,rroot=/^(?:body|html)$/i;if("getBoundingClientRect"in document.documentElement){jQuery.fn.offset=function(options){var elem=this[0],box;if(options){return this.each(function(i){jQuery.offset.setOffset(this,options,i)})}if(!elem||!elem.ownerDocument){return null}if(elem===elem.ownerDocument.body){return jQuery.offset.bodyOffset(elem)}try{box=elem.getBoundingClientRect()}catch(e){}var doc=elem.ownerDocument,docElem=doc.documentElement;if(!box||!jQuery.contains(docElem,elem)){return box||{top:0,left:0}}var body=doc.body,win=getWindow(doc),clientTop=docElem.clientTop||body.clientTop||0,clientLeft=docElem.clientLeft||body.clientLeft||0,scrollTop=win.pageYOffset||jQuery.support.boxModel&&docElem.scrollTop||body.scrollTop,scrollLeft=win.pageXOffset||jQuery.support.boxModel&&docElem.scrollLeft||body.scrollLeft,top=box.top+scrollTop-clientTop,left=box.left+scrollLeft-clientLeft;return{top:top,left:left}}}else{jQuery.fn.offset=function(options){var elem=this[0];if(options){return this.each(function(i){jQuery.offset.setOffset(this,options,i)})}if(!elem||!elem.ownerDocument){return null}if(elem===elem.ownerDocument.body){return jQuery.offset.bodyOffset(elem)}jQuery.offset.initialize();var computedStyle,offsetParent=elem.offsetParent,prevOffsetParent=elem,doc=elem.ownerDocument,docElem=doc.documentElement,body=doc.body,defaultView=doc.defaultView,prevComputedStyle=defaultView?defaultView.getComputedStyle(elem,null):elem.currentStyle,top=elem.offsetTop,left=elem.offsetLeft;while((elem=elem.parentNode)&&elem!==body&&elem!==docElem){if(jQuery.offset.supportsFixedPosition&&prevComputedStyle.position==="fixed"){break}computedStyle=defaultView?defaultView.getComputedStyle(elem,null):elem.currentStyle;top-=elem.scrollTop;left-=elem.scrollLeft;if(elem===offsetParent){top+=elem.offsetTop;left+=elem.offsetLeft;if(jQuery.offset.doesNotAddBorder&&!(jQuery.offset.doesAddBorderForTableAndCells&&rtable.test(elem.nodeName))){top+=parseFloat(computedStyle.borderTopWidth)||0;left+=parseFloat(computedStyle.borderLeftWidth)||0}prevOffsetParent=offsetParent;offsetParent=elem.offsetParent}if(jQuery.offset.subtractsBorderForOverflowNotVisible&&computedStyle.overflow!=="visible"){top+=parseFloat(computedStyle.borderTopWidth)||0;left+=parseFloat(computedStyle.borderLeftWidth)||0}prevComputedStyle=computedStyle}if(prevComputedStyle.position==="relative"||prevComputedStyle.position==="static"){top+=body.offsetTop;left+=body.offsetLeft}if(jQuery.offset.supportsFixedPosition&&prevComputedStyle.position==="fixed"){top+=Math.max(docElem.scrollTop,body.scrollTop);left+=Math.max(docElem.scrollLeft,body.scrollLeft)}return{top:top,left:left}}}jQuery.offset={initialize:function(){var body=document.body,container=document.createElement("div"),innerDiv,checkDiv,table,td,bodyMarginTop=parseFloat(jQuery.css(body,"marginTop"))||0,html="<div style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;'><div></div></div><table style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";jQuery.extend(container.style,{position:"absolute",top:0,left:0,margin:0,border:0,width:"1px",height:"1px",visibility:"hidden"});container.innerHTML=html;body.insertBefore(container,body.firstChild);innerDiv=container.firstChild;checkDiv=innerDiv.firstChild;td=innerDiv.nextSibling.firstChild.firstChild;this.doesNotAddBorder=checkDiv.offsetTop!==5;this.doesAddBorderForTableAndCells=td.offsetTop===5;checkDiv.style.position="fixed";checkDiv.style.top="20px";this.supportsFixedPosition=checkDiv.offsetTop===20||checkDiv.offsetTop===15;checkDiv.style.position=checkDiv.style.top="";innerDiv.style.overflow="hidden";innerDiv.style.position="relative";this.subtractsBorderForOverflowNotVisible=checkDiv.offsetTop===-5;this.doesNotIncludeMarginInBodyOffset=body.offsetTop!==bodyMarginTop;body.removeChild(container);body=container=innerDiv=checkDiv=table=td=null;jQuery.offset.initialize=jQuery.noop},bodyOffset:function(body){var top=body.offsetTop,left=body.offsetLeft;jQuery.offset.initialize();if(jQuery.offset.doesNotIncludeMarginInBodyOffset){top+=parseFloat(jQuery.css(body,"marginTop"))||0;left+=parseFloat(jQuery.css(body,"marginLeft"))||0}return{top:top,left:left}},setOffset:function(elem,options,i){var position=jQuery.css(elem,"position");if(position==="static"){elem.style.position="relative"}var curElem=jQuery(elem),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=position==="absolute"&&jQuery.inArray("auto",[curCSSTop,curCSSLeft])>-1,props={},curPosition={},curTop,curLeft;if(calculatePosition){curPosition=curElem.position()}curTop=calculatePosition?curPosition.top:parseInt(curCSSTop,10)||0;curLeft=calculatePosition?curPosition.left:parseInt(curCSSLeft,10)||0;if(jQuery.isFunction(options)){options=options.call(elem,i,curOffset)}if(options.top!=null){props.top=options.top-curOffset.top+curTop}if(options.left!=null){props.left=options.left-curOffset.left+curLeft}if("using"in options){options.using.call(elem,props)}else{curElem.css(props)}}};jQuery.fn.extend({position:function(){if(!this[0]){return null}var elem=this[0],offsetParent=this.offsetParent(),offset=this.offset(),parentOffset=rroot.test(offsetParent[0].nodeName)?{top:0,left:0}:offsetParent.offset();offset.top-=parseFloat(jQuery.css(elem,"marginTop"))||0;offset.left-=parseFloat(jQuery.css(elem,"marginLeft"))||0;parentOffset.top+=parseFloat(jQuery.css(offsetParent[0],"borderTopWidth"))||0;parentOffset.left+=parseFloat(jQuery.css(offsetParent[0],"borderLeftWidth"))||0;return{top:offset.top-parentOffset.top,left:offset.left-parentOffset.left}},offsetParent:function(){return this.map(function(){var offsetParent=this.offsetParent||document.body;while(offsetParent&&(!rroot.test(offsetParent.nodeName)&&jQuery.css(offsetParent,"position")==="static")){offsetParent=offsetParent.offsetParent}return offsetParent})}});jQuery.each(["Left","Top"],function(i,name){var method="scroll"+name;jQuery.fn[method]=function(val){var elem=this[0],win;if(!elem){return null}if(val!==undefined){return this.each(function(){win=getWindow(this);if(win){win.scrollTo(!i?val:jQuery(win).scrollLeft(),i?val:jQuery(win).scrollTop())}else{this[method]=val}})}else{win=getWindow(elem);return win?"pageXOffset"in win?win[i?"pageYOffset":"pageXOffset"]:jQuery.support.boxModel&&win.document.documentElement[method]||win.document.body[method]:elem[method]}}});function getWindow(elem){return jQuery.isWindow(elem)?elem:elem.nodeType===9?elem.defaultView||elem.parentWindow:false}jQuery.each(["Height","Width"],function(i,name){var type=name.toLowerCase();jQuery.fn["inner"+name]=function(){return this[0]?parseFloat(jQuery.css(this[0],type,"padding")):null};jQuery.fn["outer"+name]=function(margin){return this[0]?parseFloat(jQuery.css(this[0],type,margin?"margin":"border")):null};jQuery.fn[type]=function(size){var elem=this[0];if(!elem){return size==null?null:this}if(jQuery.isFunction(size)){return this.each(function(i){var self=jQuery(this);self[type](size.call(this,i,self[type]()))})}if(jQuery.isWindow(elem)){return elem.document.compatMode==="CSS1Compat"&&elem.document.documentElement["client"+name]||elem.document.body["client"+name]}else if(elem.nodeType===9){return Math.max(elem.documentElement["client"+name],elem.body["scroll"+name],elem.documentElement["scroll"+name],elem.body["offset"+name],elem.documentElement["offset"+name])}else if(size===undefined){var orig=jQuery.css(elem,type),ret=parseFloat(orig);return jQuery.isNaN(ret)?orig:ret}else{return this.css(type,typeof size==="string"?size:size+"px")}}})})(window);(function(){var $,VK,_VK,window,indexOf=[].indexOf||function(item){for(var i=0,l=this.length;i<l;i++){if(i in this&&this[i]===item)return i}return-1};window=this;$=window.jQuery;_VK=window.VK;return VK=window.VK={BACKSPACE:8,TAB:9,ENTER:13,SHIFT:16,CONTROL:17,CAPS_LOCK:20,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:45,DELETE:46,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,X:88,Y:89,Z:90,NUMPAD_MULTIPLY:106,NUMPAD_ADD:107,NUMPAD_ENTER:108,NUMPAD_SUBSTRACT:109,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,COMMA:188,PERIOD:190,init:function(){this.reverse={};this.keys=[];this.values=[];$.each(this,function(_this){return function(key,value){if(!isNaN(parseInt(value))&&key.toUpperCase()===key){_this.reverse[value]=key;_this.keys.push(key);_this.values.push(value)}return true}}(this));return this},noConflict:function(){window.VK=_VK;return this},getName:function(value){if(this.reverse[value]!=null){return this.reverse[value]}return value+""},getValue:function(name){name=name.toUpperCase();return this[name]},global_bindings:{},handle_key:function(e){var method_name,ref,result,target;if(e.ctrlKey||e.shiftKey||e.altKey){return}if(this.global_bindings[e.which]!=null){ref=this.global_bindings[e.which],target=ref[0],method_name=ref[1];result=target[method_name]({event:e,method_name:method_name});return e.preventDefault()}},handle_key_elements:[],auto_bind:function(target,element){var $element,binding_to_delete,i,keyvalue,len,ref;if(element==null){element=document}$element=$(element);if(target.bindables==null){target.bindables={}}binding_to_delete=[];$.each(this.global_bindings,function(_this){return function(keyvalue,targetmethod){if(targetmethod[0]===target){binding_to_delete.push(keyvalue)}return true}}(this));for(i=0,len=binding_to_delete.length;i<len;i++){keyvalue=binding_to_delete[i];delete this.global_bindings[keyvalue]}$.each(target.key_bindings,function(_this){return function(keyname,methodname){_this.global_bindings[_this.getValue(keyname)]=[target,methodname];if(!(methodname in target.bindables)){target.bindables[methodname]="??? ("+methodname+")"}return true}}(this));$.each(this.keys,function(_this){return function(index,keyname){var methodname,prefix;methodname=GM_values["VK."+keyname];if(methodname!=null){prefix=target.__name__;prefix=prefix?prefix+".":"";if(methodname.substring(0,prefix.length)===prefix){methodname=methodname.substring(prefix.length);if(methodname===""){delete _this.global_bindings[_this.getValue(keyname)]}else{_this.global_bindings[_this.getValue(keyname)]=[target,methodname]}}}return true}}(this));if(!(ref=$element[0],indexOf.call(this.handle_key_elements,ref)>=0)){this.handle_key_elements.push($element[0]);return $element.keydown(function(_this){return function(e){return _this.handle_key(e)}}(this))}},reverse:null}.init()}).call(this);(function(){var $,GalleryOverlays,ImageOverlay,QILVGallery_overlays,VK,_QILVGallery_overlays,makeClass,window;window=this;$=window.jQuery;VK=window.VK;makeClass=function(proto){proto.__init__.prototype=proto;return proto.__init__};ImageOverlay=makeClass({onload_img:function(){return $(this).css("border","2px solid black")},set_max_size:function(max_size){this.max_size=max_size;if(this.max_size){this.img.css("max-width","100%");return this.img.css("max-height","100%")}else{this.img.css("max-width","");return this.img.css("max-height","")}},set_auto_x:function(auto_x){this.auto_x=auto_x;if(this.auto_x){return this.img.css("width","100%")}else{return this.img.css("width","auto")}},set_auto_y:function(auto_y){this.auto_y=auto_y;if(this.auto_y){return this.img.css("height","100%")}else{return this.img.css("height","auto")}},update:function(selector){if(this.img!=null){this.img.remove()}this.img=$("<img id='QILVGallery_Current_"+this.index+"' class='QILVGallery_Current' src='#' style='display:block;position:absolute;left:0;top:0;z-index:50000' />");this.img.css("position",this.position);this.img.load(this.onload_img);this.img.attr("current",selector);this.img.css("border","2px solid red");this.img.css("-moz-box-sizing","border-box");this.img.attr("src",$(this.img.attr("current")).attr("href"));this.set_auto_x(this.auto_x);this.set_auto_y(this.auto_y);this.set_max_size(this.max_size);this.a.attr("href",$(this.img.attr("current")).attr("href"));this.a.attr("target","_blank");this.a.append(this.img);if(this.is_centeronscreen){this.centeronscreen()}else{this.uncenteronscreen()}return $("#QILVGallery_Infotip").remove()},hide:function(){if(this.transition_time>0){this.img.css("z-index",50001);this.img.fadeOut(this.transition_time,function(_this){return function(){_this.div.css("display","none");return _this.img.css("z-index",5e4)}}(this))}else{this.div.css("display","none")}return this.a.removeAttr("accesskey")},show:function(){this.a.attr("accesskey","l");if(this.transition_time>0){this.img.css("z-index",5e4);this.img.css("display","none");this.div.css("display","block");return this.img.fadeIn(this.transition_time,function(_this){return function(){}}(this))}else{return this.div.css("display","block")}},is_on:function(){return!(this.div.css("display")==="none")},toggle:function(){if(this.is_on()){return this.hide()}else{return this.show()}},togglecenteronscreen:function(){if(this.is_centeronscreen){return this.uncenteronscreen()}else{return this.centeronscreen()}},centeronscreen:function(){this.img.css("right","0");this.img.css("bottom","0");this.img.css("margin","auto");return this.is_centeronscreen=true},uncenteronscreen:function(){this.img.css("right","");this.img.css("bottom","");this.img.css("margin","");return this.is_centeronscreen=false},get_relative:function(){return this.position==="fixed"},set_relative:function(relative){this.position=relative?"fixed":"absolute";return this.img.css("position",this.position)},toggleposition:function(){return this.set_relative(!this.get_relative())},set_transition_time:function(transition_time){return this.transition_time=transition_time},__init__:function(index){this.div=$("<div id='QILVGallery_Overlay_"+index+"' style='display:none'/>");this.a=$("<a/>");this.index=index;this.position="absolute";this.is_centeronscreen=false;this.transition_time=0;$("body").append(this.div.append(this.a));return null}});GalleryOverlays=makeClass({__name__:"Gallery",jquery:$,prev:null,next:null,current:null,slideshow_mode:false,preload_all_mode:true,slideshow_dir_next:true,slideshow_speed:500,auto_x:false,auto_y:false,max_size:true,relative:false,is_center_on_screen:false,is_black_screen:true,transition_time:0,noConflict:function(){window.QILVGallery_overlays=_QILVGallery_overlays;return this},set_transition_time:function(transition_time,silent){this.transition_time=transition_time;$.each(["prev","next","current"],function(_this){return function(index,element){_this[element].set_transition_time(transition_time);return true}}(this));if(!silent){return this.create_infotip({content:"Transition's effect's time : "+transition_time+" ms",fadeOut:0,appendTo:"body",position:"fixed"})}},cycle_transition_time:function(){if(this.transition_time===0){this.transition_time=300}else if(this.transition_time<=300){this.transition_time=800}else if(this.transition_time<=800){this.transition_time=1500}else{this.transition_time=0}return this.set_transition_time(this.transition_time)},set_center_on_screen:function(is_center_on_screen){$.each(["prev","next","current"],function(_this){return function(index,element){if(_this[element]){if(is_center_on_screen){_this[element].centeronscreen()}else{_this[element].uncenteronscreen()}}return true}}(this));return this.is_center_on_screen=is_center_on_screen},set_black_screen:function(is_black_screen){var $black_screen,$div;$black_screen=$("#QILVGallery_black_screen");if(is_black_screen&&$black_screen.length===0){$div=$("<div id='QILVGallery_black_screen'/>");$("body").append($div);$div.css("z-index","49998");$div.css("width","100%");$div.css("height","100%");$div.css("position","fixed");$div.css("left","0");$div.css("top","0");$div.css("background","black")}if(!is_black_screen&&$black_screen.length>0){$black_screen.remove()}this.set_center_on_screen(is_black_screen);return this.is_black_screen=is_black_screen},show_slideshow_slide:function(){if(this.slideshow_mode){if(this.slideshow_dir_next){this.go_next()}else{this.go_prev()}return this.prepare_next_slide()}},prepare_next_slide:function(){return setTimeout(function(_this){return function(){return _this.show_slideshow_slide()}}(this),this.slideshow_speed)},start_slideshow:function(){this.slideshow_mode=true;return this.prepare_next_slide()},stop_slideshow:function(){return this.slideshow_mode=false},startstop_slideshow:function(){if(this.slideshow_mode){return this.stop_slideshow()}else{return this.start_slideshow()}},speedup_slideshow:function(){if(this.slideshow_speed>100){this.slideshow_speed=this.slideshow_speed-100}return this.create_infotip({content:"Speed : "+this.slideshow_speed+" ms",fadeOut:0,appendTo:"body",position:"fixed"})},speeddown_slideshow:function(){this.slideshow_speed=this.slideshow_speed+100;return this.create_infotip({content:"Speed : "+this.slideshow_speed+" ms",fadeOut:0,appendTo:"body",position:"fixed"})},go_prev:function(){var ref;this.slideshow_dir_next=false;this.current.hide();ref=[this.next,this.current,this.prev],this.prev=ref[0],this.next=ref[1],this.current=ref[2];this.current.show();this.prev.update($(this.current.img.attr("current")).attr("gprev"));return this.set_black_screen(this.is_black_screen)},go_next:function(){var ref;this.slideshow_dir_next=true;this.current.hide();ref=[this.prev,this.current,this.next],this.next=ref[0],this.prev=ref[1],this.current=ref[2];this.current.show();this.next.update($(this.current.img.attr("current")).attr("gnext"));return this.set_black_screen(this.is_black_screen)},go_num:function(num){this.current.update(".QILVGallery_Image_"+num);this.prev.update($(this.current.img.attr("current")).attr("gprev"));this.next.update($(this.current.img.attr("current")).attr("gnext"));return this.set_black_screen(this.is_black_screen)},toggle_max_size:function(){this.max_size=!this.max_size;this.current.set_max_size(this.max_size);this.prev.set_max_size(this.max_size);this.next.set_max_size(this.max_size);return this.create_infotip({content:this.max_size?"Max size : 100%":"No max size",fadeOut:500,appendTo:"body",position:"fixed"})},toggle_auto_x:function(){this.auto_x=!this.auto_x;this.current.set_auto_x(this.auto_x);this.prev.set_auto_x(this.auto_x);return this.next.set_auto_x(this.auto_x)},toggle_auto_y:function(){this.auto_y=!this.auto_y;this.current.set_auto_y(this.auto_y);this.prev.set_auto_y(this.auto_y);return this.next.set_auto_y(this.auto_y)},toggle_auto_xy:function(){if(this.auto_x||this.auto_y){this.auto_x=false;this.auto_y=false}else{this.auto_x=true;this.auto_y=true}this.current.set_auto_x(this.auto_x);this.prev.set_auto_x(this.auto_x);this.next.set_auto_x(this.auto_x);this.current.set_auto_y(this.auto_y);this.prev.set_auto_y(this.auto_y);return this.next.set_auto_y(this.auto_y)},is_current:function(href){return this.current.img[0].src===href},create_infotip:function(params){var $info_tip;if(params==null){params={}}$info_tip=$("<div style='display:block;position:absolute;left:4px;top:4px;padding:15px;font-size:13px;background:#e9ecf9;color:#000000;font-family:courier new;border-left:2px solid #9999bb;border-top:2px solid #9999bb;border-right:2px solid #5555aa;border-bottom:2px solid #5555aa;-moz-border-radius:15px;-webkit-border-radius:15px;z-index:50001'/>");if(params.id!=null){$info_tip.attr("id",params.id)}if(params.position){$info_tip.css("position",params.position)}if(params.content){$info_tip.html(params.content)}if(params.appendTo){$(params.appendTo).append($info_tip)}if(params.fadeOut!=null){setTimeout(function(_this){return function(){return $info_tip.fadeOut("slow",function(){return $info_tip.remove()})}}(this),params.fadeOut);$(params.appendTo).append($info_tip)}if(params.center!=null&&params.center){$info_tip.css("position","fixed");$info_tip.css("left","0");$info_tip.css("right","0");$info_tip.css("top","0");$info_tip.css("bottom","0");$info_tip.css("margin","auto")}return $info_tip},toggle_infobox:function(){var $info_tip,$info_tip_pre,text;if($("#QILVGallery_Infotip").length>0){return $("#QILVGallery_Infotip").remove()}else{$info_tip=this.create_infotip({id:"QILVGallery_Infotip"});$info_tip_pre=$("<pre/>");$info_tip.append($info_tip_pre);text="";$.each($(".QILVGallery_Image"),function(_this){return function(index,this_a){if(_this.is_current(this_a.href)){text+="<b>"}text+=this_a.href;if(_this.is_current(this_a.href)){text+="</b>"}text+="\n";return true}}(this));$info_tip_pre.html(text);$info_tip_pre.click(function(_this){return function(){var $info_tip_area,count,max_len;text="";count=0;max_len=0;$.each($(".QILVGallery_Image"),function(index,this_a){text+=this_a.href;text+="\n";count+=1;if(this_a.href.length>max_len){max_len=this_a.href.length}return true});$info_tip_pre.remove();$info_tip_area=$("<textarea rows='"+(count+1)+"' cols='"+(max_len+2)+"' style='white-space:pre;' readonly/>");$info_tip.append($info_tip_area);$info_tip_area.val(text);return $info_tip_area.select()}}(this));return $("body").append($info_tip)}},toggle:function(){if(this.current.is_on()){$("#QILVGallery_black_screen").remove()}else{this.set_black_screen(this.is_black_screen)}return this.current.toggle()},toggleposition:function(){return this.set_relative(!this.relative)},set_relative:function(relative){this.relative=relative;this.current.set_relative(this.relative);this.next.set_relative(this.relative);return this.prev.set_relative(this.relative)},toggle_black_screen:function(){this.is_black_screen=!this.is_black_screen;return this.set_black_screen(this.is_black_screen)},open_link:function(){return window.open(this.current.img[0].src)},show_preload_gauge:function(){var $gauge_container,$gauge_inner;if($("#QILVGallery_preload_gauge").length===0){$gauge_container=$("<div id='QILVGallery_preload_gauge' style='z-index:50101;border:1px solid black;width:100%;position:fixed;bottom:0;height:13px;background-color:#eee' />");$gauge_inner=$("<div id='QILVGallery_preload_gauge_inner' style='z-index:50102;border:0;padding:0;margin:0;width:0%;position:static;left:0;top:0;height:100%;background-color:#f03;text-align:center;font-size:11px;font-family:Arial,Verdana,sans-serif,Helvetica;font-weight:bold;color:#000000' />");$gauge_container.append($gauge_inner);$("body").append($gauge_container);return this.update_preload_gauge()}},hide_preload_gauge:function(){return $("#QILVGallery_preload_gauge").remove()},update_preload_gauge:function(){var panel;if($("#QILVGallery_preload_gauge").length>0){panel=$("#QILVGallery_preload_all_panel")[0];$("#QILVGallery_preload_gauge_inner").css("width",Math.floor(panel._loaded*100/panel._total)+"%");$("#QILVGallery_preload_gauge_inner").html(panel._loaded+" / "+panel._total);if(panel._loaded===panel._total){return $("#QILVGallery_preload_gauge").fadeOut(2e3,function(_this){return function(){return $(_this).remove()}}(this))}}},preload_all:function(){var $images,$panel;if($("#QILVGallery_preload_all_panel").length===0){$panel=$("<div id='QILVGallery_preload_all_panel' style='display:none' />");$images=$(".QILVGallery_Image");$panel[0]._total=$images.length;$panel[0]._loaded=0;$images.each(function(_this){return function(index,this_a){var $img;$img=$("<img src='#'/>");$img.attr("src",this_a.href);$img.load(function(){$panel[0]._loaded+=1;return _this.update_preload_gauge()});$panel.append($img);return true}}(this));$("body").append($panel);return this.show_preload_gauge()}else{if($("#QILVGallery_preload_gauge").length===0){return this.show_preload_gauge()}else{return this.hide_preload_gauge()}}},about:function(){var $close_button,$div,$info_tip,on_click;if($("#QILVGallery_About").length>0){$("#QILVGallery_About").remove();return $("#QILVGallery_About_black_screen").remove()}else{$info_tip=this.create_infotip({id:"QILVGallery_About",center:true});$info_tip.css("font-family",'"Trebuchet MS",Tahoma,Verdana,Arial,sans-serif').css("font-size","15pt").css("text-align","center");$info_tip.css("max-width","500px");$info_tip.css("max-height","300px");$info_tip.css("border","1px solid white");$info_tip.css("background","#a2a2a2");$info_tip.css("background","-moz-linear-gradient(90deg,#888,#ddd)");$info_tip.css("background","-webkit-linear-gradient(90deg,#888,#ddd)");$info_tip.css("z-index","50100");$info_tip.append($("<p>QILV Gallery</p>").css("font-size","20pt"));$info_tip.append("<a href='http://code.google.com/p/qilvgallery/' target='_blank'>http://code.google.com/p/qilvgallery/</a>");$info_tip.append($("<br/>"));$close_button=$("<div>Close</div>");$close_button.css("width","20em");$close_button.css("width","20em");$close_button.css("border","1px solid #fff");$close_button.css("background","#ccc");$close_button.css("background","-moz-linear-gradient(90deg, #aaa, #eee)");$close_button.css("-moz-border-radius","8px");$close_button.css("-webkit-border-radius","8px");$close_button.css("left","0");$close_button.css("right","0");$close_button.css("margin","100px auto auto");$close_button.css("border","1px solid #666");$div=$("<div id='QILVGallery_About_black_screen'/>");$div.css("z-index","49998");$div.css("width","100%");$div.css("height","100%");$div.css("position","fixed");$div.css("left","0");$div.css("top","0");$div.css("background","black");$div.css("z-index","50098");$div.css("opacity","0.8");$("body").append($div);$("body").append($info_tip);on_click=function(){$("#QILVGallery_About").remove();return $("#QILVGallery_About_black_screen").remove()};$close_button.click(on_click);$info_tip.append($close_button);return $div.click(on_click)}},help:function(){var $info_tip,$info_tip_div;if($("#QILVGallery_Help").length>0){return $("#QILVGallery_Help").remove()}else{$info_tip=this.create_infotip({id:"QILVGallery_Help"});$info_tip.css("font-family",'"Trebuchet MS",Tahoma,Verdana,Arial,sans-serif').css("font-size","10pt").css("text-align","left");$info_tip.append($("<h1/>").css("font-size","2em").css("font-weight","bold").html("Keyboard configuration"));$info_tip_div=$("<div/>").css("margin-left","10px");$.each(VK.global_bindings,function(_this){return function(vk_value,vk_props){if(vk_props[0]===_this){$info_tip_div.append($("<div/>").html("<b>"+VK.getName(vk_value)+"</b>: "+(vk_props[1]in _this.bindables?_this.bindables[vk_props[1]]:vk_props[1])))}return true}}(this));$info_tip.append($info_tip_div);$info_tip.append($("<h1/>").css("font-size","2em").css("font-weight","bold").html("Values"));$info_tip_div=$("<div/>").css("margin-left","10px");$.each(this.configurables,function(_this){return function(attr,comment){$info_tip_div.append($("<div/>").html("<b>"+comment+" (current value)</b>: "+(GM_values["QILV."+attr]||"default")+" ("+_this[attr]+")"));return true}}(this));$info_tip.append($info_tip_div);return $("body").append($info_tip)}},configurables:{slideshow_speed:"Initial slideshow speed (ms)",transition_time:"Initial transition's effect's time (ms)",slideshow_mode:"Slideshow on at start ?",preload_all_mode:"Preload all at start ?",max_size:"Fit the image to the screen if bigger than the screen at start ?",relative:"Show image at the top of the screen instead of the top of the page at start ?",is_black_screen:"Show on 'black screen' mode at start ?"},bindables:{go_prev:"Go to previous image",go_next:"Go to next image",toggle_infobox:"Show/hide the infobox of image list",
toggle:"Show/Hide the current image",open_link:"Open the image in a new window/tab",startstop_slideshow:"Start/stop the slideshow",toggleposition:"Show current image at top of the page/top of the screen",speedup_slideshow:"Increase the slideshow speed",speeddown_slideshow:"Decrease the slideshow speed",toggle_max_size:"Fit the image if larger than the screen/Show whole image",toggle_auto_x:"Width of the image fit/doesn't fit to width of the screen",toggle_auto_y:"Height of the image fit/doesn't fit to height of the screen",toggle_auto_xy:"Width and height of the image fit/doesn't fit to width and height of the screen",toggle_black_screen:"Set or remove the black screen",cycle_transition_time:"Change transition's effect's time",preload_all:"Pre-load all images (may take some resources)",about:"Show/Hide about box",help:"Show/Hide help box"},key_bindings:{BACKSPACE:"go_prev",J:"go_prev",SPACE:"go_next",K:"go_next",I:"toggle_infobox",H:"toggle",L:"open_link",S:"startstop_slideshow",R:"toggleposition",NUMPAD_ADD:"speedup_slideshow",NUMPAD_SUBSTRACT:"speeddown_slideshow",M:"toggle_max_size",X:"toggle_auto_x",Y:"toggle_auto_y",Z:"toggle_auto_xy",B:"toggle_black_screen",T:"cycle_transition_time",P:"preload_all",NUMPAD_MULTIPLY:"help",NUMPAD_DIVIDE:"about"},__init__:function(){},init:function(){var $link_list,element,index,index_element,j,len,previouslink,ref;window.test={};window.test.ImageOverlay=ImageOverlay;window.test.makeClass=makeClass;ref=[[0,"prev"],[1,"current"],[2,"next"]];for(j=0,len=ref.length;j<len;j++){index_element=ref[j];index=index_element[0],element=index_element[1];this[element]=new ImageOverlay(index)}previouslink=void 0;$link_list=$("a").filter(function(_this){return function(index,this_a){var link,ok;link=$(this_a).attr("href");if(link){ok=false;$.each([".png",".gif",".jpg",".jpeg"],function(i,element){if(link.substr(link.length-element.length,element.length).toLowerCase()===element){if(link!==previouslink){ok=true;previouslink=link}}return true})}return ok}}(this));$.each($link_list,function(_this){return function(index,this_a){$(this_a).addClass("QILVGallery_Image");$(this_a).addClass("QILVGallery_Image_"+index);$(this_a).attr("gprev",".QILVGallery_Image_"+(index===0?$link_list.length-1:index-1));$(this_a).attr("gnext",".QILVGallery_Image_"+(index===$link_list.length-1?0:index+1));return true}}(this));this.go_num(0);VK.auto_bind(this);$.each(this.configurables,function(_this){return function(keyname,v){var value;value=GM_values["QILV."+keyname];if(value!=null){if(value.match(/^\-?[0-9]+$/)){value=parseInt(value)}if(value==="false"){value=false}if(value==="true"){value=true}_this[keyname]=value}return true}}(this));if($link_list.length>0){this.current.show()}else{this.stop_slideshow();this.is_black_screen=false;this.set_black_screen(this.is_black_screen);this.create_infotip({content:"No links to image found in this page !",fadeOut:1500,appendTo:"body",position:"fixed"})}this.current.set_max_size(this.max_size);this.prev.set_max_size(this.max_size);this.next.set_max_size(this.max_size);if(this.slideshow_mode){this.prepare_next_slide()}if(this.preload_all_mode){this.preload_all()}this.set_relative(this.relative);this.set_black_screen(this.is_black_screen);this.set_transition_time(this.transition_time,true);return this}});_QILVGallery_overlays=window.QILVGallery_overlays;QILVGallery_overlays=window.QILVGallery_overlays=new GalleryOverlays}).call(this);(function(){jQuery(function($){var addkeysbuttons,addvaluesbuttons,prefix_url,ref,setlink,setlink_using_param,setlinkname,suffix_url;ref=[window.qilv_prefix_url,window.qilv_suffix_url],prefix_url=ref[0],suffix_url=ref[1];setlink=function(keyboard_config){var first,keystring;keystring="";if(keyboard_config!=null){keystring="window.GM_values={";first=true;$.each(keyboard_config,function(key,value){if(!first){keystring+=","}first=false;keystring+="'";keystring+=key;keystring+="':'";keystring+=value;keystring+="'";return null});keystring+="};"}$("#gallery_link").attr("href","javascript:(function(){if(window.QILVGallery_overlays){window.QILVGallery_overlays.current.show();}else{"+keystring+"var n=document.createElement('script');n.type='text/javascript';n.src='"+prefix_url+"qilvgallery-total.min.js"+suffix_url+"';document.getElementsByTagName('head')[0].appendChild(n);}})();");$("#gallery_link").hide();return $("#gallery_link").fadeIn("slow")};setlinkname=function(){return $("#gallery_link").text($("#namefield").val())};setlink_using_param=function(){var config;config={};$("#keyspanel table tr").each(function(index,tr){var action,key;key=$(tr).find("td.key select").val();action=$(tr).find("td.action select").val();if(key!==""){if(QILVGallery_overlays.key_bindings[key]!==action){config["VK."+key]=QILVGallery_overlays.__name__+"."+action}}return null});$("#valuespanel table tr").each(function(index,tr){var name,value;name=$(tr).find("td.key select").val();value=$(tr).find("td.action input").val();if(value.match(/^\-?[0-9]+$/)){value=parseInt(value)}if(value==="true"){value=true}if(value==="false"){value=false}if(QILVGallery_overlays[name]!==value){config["QILV."+name]=value}return null});setlink(config);return null};addkeysbuttons=function(keyname,actionname){var $combo,$line;$line=$("<tr><td class='key'></td><td class='action'></td></tr>");$("#keyspanel table").append($line);$line.find("td").css("width","50%");$combo=$('<select style="width:100%"/>');$line.find("td.key").append($combo);$combo.append($("<option/>").html("-- select a key --").attr("value",""));$.each(VK.keys,function(index,key){var $option;$option=$("<option/>").html(key).attr("value",key);if(key===keyname){$option.attr("selected","true")}$combo.append($option);return null});$combo.change(setlink_using_param);$combo=$('<select style="width:100%"/>');$line.find("td.action").append($combo);$combo.append($("<option/>").html("-- no action --").attr("value",""));$.each(QILVGallery_overlays.bindables,function(value,comment){var $option;$option=$("<option/>").html(comment).attr("value",value);if(value===actionname){$option.attr("selected","true")}$combo.append($option);return null});$combo.change(setlink_using_param);return null};addvaluesbuttons=function(name,value,comment){var $combo,$line;$line=$("<tr><td class='key'></td><td class='action'></td></tr>");$("#valuespanel table").append($line);$line.find("td").css("width","50%");$combo=$('<select style="width:100%"/>');$line.find("td.key").append($combo);$combo.append($("<option/>").html(comment).attr("value",name));$combo.change(setlink_using_param);$combo=$('<input style="width:100%"/>').html(value).attr("value",value);$line.find("td.action").append($combo);$combo.change(setlink_using_param);return null};setlink({});$("#namepanel").append("<input id='namefield' style='width:100%'/>");$("#namefield").change(setlinkname).keyup(setlinkname).val($("#gallery_link").text());$("#keyboardpanel").append("<div id='keyspanel'/>").append("<div id='pluskeyspanel' class='pluspanel'/>");$("#keyspanel").append("<table style='width:100%'></table>");$("#pluskeyspanel").append("<button id='pluskeysbutton' class='plusbutton' type='submit'>+</button>").click(function(){addkeysbuttons();$combo.change(setlink_using_param);return null});$.each(QILVGallery_overlays.key_bindings,function(key,action){return addkeysbuttons(key,action)});$("#valuepanel").append("<div id='valuespanel'/>");$("#valuespanel").append("<table style='width:100%'></table>");$.each(QILVGallery_overlays.configurables,function(name,comment){return addvaluesbuttons(name,QILVGallery_overlays[name],comment)});return setlink_using_param()})}).call(this);